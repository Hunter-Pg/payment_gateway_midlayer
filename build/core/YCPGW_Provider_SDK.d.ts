...
export declare class YCPGW_Provider_SDK extends YCPGW_Lib_Internal implements YCPGW_Provider_SDK_Interface {
    ...
    Card_Token_Fetch(txInfo: YCPGW_Transaction_Info): Promise<YCPGW_Transaction_Result>;
}
